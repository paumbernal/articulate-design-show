  ...
  return (
    <div className="border border-foreground/10 rounded-xl p-5 bg-foreground/[0.02] flex flex-col gap-4">
      <div className="flex items-center justify-between flex-wrap gap-2">
        <h4 className="font-mono text-xs uppercase tracking-wide text-text-muted">Statistical Validation</h4>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        ...
        <div>
          <p className="font-mono text-[10px] uppercase text-text-muted mb-1">Avg R 95% CI</p>
        ...
        <div>
          <p className="font-mono text-[10px] uppercase text-text-muted mb-1">Method</p>
          <p className="font-mono text-[11px] leading-tight">{significance.method}</p>
        </div>
      </div>
      ...
      {validation.warnings.length > 0 && (
        <div className="flex flex-col gap-1.5 border-t border-foreground/10 pt-3">
          {validation.warnings.map((w) => (
            <div key={w} className="flex items-start gap-2 text-[11px] font-mono text-text-muted">
